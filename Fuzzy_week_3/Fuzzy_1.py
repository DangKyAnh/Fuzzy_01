...
tipping_systems = ctrl.ControlSystemSimulation(systems_1, flush_after_run = 61*61+1)  # Tinh toan va gan bien mo phong
...
suf = ax.plot_surface(x,y,z, rstride = 1, cstride = 1, cmap  = 'viridis', linewidth = 0.4, antialiased = Time)
